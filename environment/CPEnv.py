    ...
    def __init__(self, instance_filename: str):
        ...
        if sys.platform.startswith("linux"):
            context.solver.local.execfile = (
                "/opt/ibm/ILOG/CPLEX_Studio2211/cpoptimizer/bin/x86-64_linux/cpoptimizer"
            )
        #elif sys.platform == "darwin":
        #    context.solver.local.execfile = (
        #        "/Applications/CPLEX_Studio2211/cpoptimizer/bin/x86-64_osx/cpoptimizer"
        #    )

        #context.solver.local.execfile = "C:\\Program Files\\IBM\\ILOG\\CPLEX_Studio2211\\cpoptimizer\\bin\\x64_win64\\cpoptimizer.exe"
